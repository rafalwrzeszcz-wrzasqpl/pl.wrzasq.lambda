...
[Organization](https://docs.aws.amazon.com/AWSJavaSDK/latest/javadoc/com/amazonaws/services/organizations/model/Organization.html)
object. However it's not important as account can manage just one organization and organization data is never needed in
further calls.

**Note:** Custom resource physical ID is set as created organization
