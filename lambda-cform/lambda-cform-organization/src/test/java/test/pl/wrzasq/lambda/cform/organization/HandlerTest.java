...
{
    @Mock
    private CustomResourceHandler<OrganizationRequest, Organization> handler;

    @Mock
    private Context context;

    private CustomResourceHandler<OrganizationRequest, Organization> originalHandler;
    ...
    private CustomResourceHandler<OrganizationRequest, Organization> setHandler(
        CustomResourceHandler<OrganizationRequest, Organization> sender
    )
        throws NoSuchFieldException, IllegalAccessException
    {
        Field hack = Handler.class.getDeclaredField("handler");
        hack.setAccessible(true);
        CustomResourceHandler<OrganizationRequest, Organization> original
